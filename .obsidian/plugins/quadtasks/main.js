...
__export(main_exports, {
  default: () => EisenhowerMatrixPlugin
});
...
var EisenhowerMatrixPlugin = class extends import_obsidian.Plugin {
  constructor() {
    super(...arguments);
    this.viewStateCache = /* @__PURE__ */ new Map();
  }
  async onload() {
...
var MatrixRenderChild = class extends import_obsidian.MarkdownRenderChild {
  constructor(containerEl, source, ctx, app, plugin) {
    ...
    this.app = app;
    this.plugin = plugin;
    this.debouncedSave = (0, import_obsidian.debounce)(this.saveChanges.bind(this), 500, true);
  }
  get state() {
  ...
  render() {
    ...
    QUADRANTS.forEach((q) => {
      if (focusedQuadrant && focusedQuadrant !== q.id)
        return;
      ...
      (0, import_obsidian.setIcon)(focusBtn, focusedQuadrant === q.id ? "minimize-2" : "maximize-2");
    ...
    if (!focusedQuadrant) {
      ...
      (0, import_obsidian.setIcon)(inboxIcon, "inbox");
  ...
  renderTaskItem(task, container) {
    ...
    import_obsidian.MarkdownRenderer.renderMarkdown(task.text, textDiv, this.ctx.sourcePath, this);
    ...
    li.addEventListener("dragstart", (e) => {
      ...
      (_a = e.dataTransfer) == null ? void 0 : _a.setData("text/plain", JSON.stringify(task));
  ...
  updateDragIndicator(container, afterElement) {
    this.removeDragIndicator();
...
var CreateTaskModal = class extends import_obsidian.Modal {
  constructor(app, showBuffer, onSubmit) {
    super(app);
    ...
    categories.forEach((cat) => {
      ...
      option.onclick = () => {
        ...
        options.forEach((opt) => {
          ...
          opt.querySelector(".category-radio").checked = false;
        });
