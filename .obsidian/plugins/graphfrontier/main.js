    ...
    function stepSimulation(view) {
        ...
        for (let indexA = 0; indexA < nodeCount; indexA += 1) {
          ...
          for (let indexB = indexA + 1; indexB < nodeCount; indexB += 1) {
            ...
            if (attachmentIsolationMode) {
              const nodeAIsAttachment = !!((_d = nodeA == null ? void 0 : nodeA.meta) == null ? void 0 : _d.isAttachment);
              const nodeBIsAttachment = !!((_e = nodeB == null ? void 0 : nodeB.meta) == null ? void 0 : _e.isAttachment);
      ...
      if (hasLink) {
        for (const edge of view.edges) {
          ...
          const sourceIsAttachment = !!((_f = sourceNode.meta) == null ? void 0 : _f.isAttachment);
          const targetIsAttachment = !!((_g = targetNode.meta) == null ? void 0 : _g.isAttachment);
      ...
      for (const node of nodes) {
        ...
        const isAttachmentNode = !!((_h = node == null ? void 0 : node.meta) == null ? void 0 : _h.isAttachment);
